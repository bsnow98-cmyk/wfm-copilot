...
| 4 | `apply_forecast_override` | Pin a forecast interval to an analyst value | Medium | M | Named deferred in CHAT_WRITE_ACTIONS §Out-of-scope. Audit + undo matter most here (downstream staffing depends on it). |
